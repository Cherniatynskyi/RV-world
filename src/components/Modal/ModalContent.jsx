    ...
    <div className={css.modalContent}>
        <div className={css.mainContetn}>
            <div className={css.modalHeaderInfo}>
                ...
                <div className={css.subInfo}>
                    <span style={{textDecoration: "underline", textUnderlineOffset: "3px"}} className={css.subInfoTitle}>
                        <svg style= {{fill: "#FFC531", stroke:"transparent"}} className={css.subInfoSvg}>
                            <use href={`${sprite}#icon-star`}/>
                        </svg>
                        {`${card.rating} (${card.reviews.length} Reviews)`}
                    </span>
                    <a href={`https://www.google.com/maps/search/?api=1&query=${card.location}`}>
            ...
            <ul className={css.imgList}>
                {card.gallery.map(image => {
                    return(
                        <li><img className={css.img}src={image} alt='RV'></img></li>
                    )
                })}
            </ul>
        ...
        <div className={css.subContent}>
            <div className={css.modalNav}>
                <button onClick={(e)=>handleSubType(e)} style={subType === "features" ?{color: "#d04c42", borderBottom: "3px solid #d04c42"}:{}} className={css.modalNavBtn} id='features'>Features</button>
